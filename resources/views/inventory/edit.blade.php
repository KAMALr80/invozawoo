...
<style>
    ...
    * {
    ...
    .info-value.stock {
        color: {{ $product->quantity <= 10 ? 'var(--danger)' : 'var(--success)' }};
    }
            ...
            <div class="form-header">
                ...
                <div class="header-content">
                    ...
                    <div class="header-text">
                        ...
                        <p class="header-subtitle">Update product information and image</p>
                    </div>
                </div>
            </div>
            ...
            <div class="product-info-card">
                <div class="product-info-grid">
                    ...
                    <div class="info-badge">
                        ...
                        <div class="info-value stock">{{ $product->quantity }} units</div>
                    </div>

                    <div class="info-badge">
                        <div class="info-label">Category</div>
                        <div class="info-value">{{ $product->category ?? 'Uncategorized' }}</div>
                    </div>
                ...
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $product->product_code }}" readonly class="form-input" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="form-label">
                                <span class="label-icon purple">🏷️</span>
                                Category
                            </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                <input type="number" name="quantity" value="{{ old('quantity', $product->quantity) }}"
                                    min="0" required class="form-input {{ $errors->has('quantity') ? 'error' : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                <input type="number" name="price" value="{{ old('price', $product->price) }}"
                                    step="0.01" min="0" required class="form-input {{ $errors->has('price') ? 'error' : '' }}">
                ...
                <div class="image-section">
                    ...
                    <div id="upload-input" style="display: block;">
                        <div class="upload-area"
                            ...
                            <p class="upload-text">Click to upload new image</p>
                    ...
                    <!-- New Image Preview -->
                    <div id="image-preview" class="new-image-preview">
